...
\chead{}
\rhead{\bf Prot. Nr.~83 ; \today} % Bandymų protokolo numerį reikia įrašyti. 
...
\begin{center}
	{\Large Betono kubelinio stiprio nustatymas pagal {\bf LST EN 12390-3}\\
		Bandymų protokolas {\bf \Large \textcolor{blue}{Nr.~83,  \today }}\\ % Bandymų protokolo numerį reikia įrašyti. Jis gali būti generuojamas  automatiškai programos, tačiau tas protokolo numeris negali kartotis, kiekvieno protokolo numeris turi būti vienintelis, unikalus
	}
\end{center}

{\hspace{2.5cm} {\bf Užsakovas:} \hfill \parbox{12.0cm}{Saulėtekio pastatai, Saulėtekio al. 522, Vilnius, Įmonės kodas, 856925514}} % Reikia čia įrašyti užsakovo rekvizitus  iš programos atitinkamo įvedimo lango
...
\hspace{5.25cm} {\bf Bandymai atlikti:} {2024 m. gegužės 06 d.} % Reikia čia įrašyti bandymų atlikimo datą iš programos įvedimo lango

\hspace{5.25cm} \nin {\bf Bandiniai gauti:} {2024 m. gegužės 01 d.} % Reikia čia įrašyti bandinių gavimo datą iš programos įvedimo lango
...
\hspace{5.25cm} {\bf Bandė:} {Domas Milinavičius}. % Reikia čia įrašyti laboranto vardą ir pavardę
...
$ 1 $ kubeliai (kubeliai) neatiktiniai. % Šis įrašas daromas jei yra išbrokuotų kubelių,
...
\begin{table}[H] % Čia turėtu būti parametras [t] lentelės patalpinimui puslapio viršuje
	...
	\begin{tabular}
		...
		\hline
		3 & 150.006 \\ 150 \\ 149.993 \\ 150 \\ 150 \\ 150 & 150 \\ 150.004 \\ 150 \\ 150 \\ 150 \\ 150 & 988  & 43.911 & \small{} \\
		\hline
		\end{tabular}%
...
\begin{enumerate}
	\item \hspace{\parindent}Vidutinio gniuždomojo striprio įvertis $ f_{cm,cube} =  43.7033 $ MPa % Čia reikia įrašyti apskaičiuotą betono vidutinio stiprio įvertį
	...
	\item  Charakteristinio stiprio įvertis $ f_{ck,cube} = 39.703 $ MPa % Čia reikia įrašyti apskaičiuotą betono kubelinio stiprumo standartinio nuokrypio įvertį
