...
\chead{}
\rhead{\bf Prot. Nr.~98 ; \today} % Bandymų protokolo numerį reikia įrašyti. 
...
\begin{center}
	{\Large Betono kubelinio stiprio nustatymas pagal {\bf LST EN 12390-3}\\
		Bandymų protokolas {\bf \Large \textcolor{blue}{Nr.~98 ; \today }}\\ % Bandymų protokolo numerį reikia įrašyti. Jis gali būti generuojamas  automatiškai programos, tačiau tas protokolo numeris negali kartotis, kiekvieno protokolo numeris turi būti vienintelis, unikalus
	}
\end{center}
...
\hspace{5.25cm} {\bf Bandymai atlikti:} {2024 m. gegužės 23 d.} % Reikia čia įrašyti bandymų atlikimo datą iš programos įvedimo lango

\hspace{5.25cm} \nin {\bf Bandiniai gauti:} {2024 m. gegužės 23 d.} % Reikia čia įrašyti bandinių gavimo datą iš programos įvedimo lango
