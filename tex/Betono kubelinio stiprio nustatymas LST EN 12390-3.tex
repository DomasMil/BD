...
\chead{}
\rhead{\bf Prot. Nr.~87 ; \today} % Bandymų protokolo numerį reikia įrašyti. 
...
\begin{center}
	{\Large Betono kubelinio stiprio nustatymas pagal {\bf LST EN 12390-3}\\
		Bandymų protokolas {\bf \Large \textcolor{blue}{Nr.~87}}\\ % Bandymų protokolo numerį reikia įrašyti. Jis gali būti generuojamas  automatiškai programos, tačiau tas protokolo numeris negali kartotis, kiekvieno protokolo numeris turi būti vienintelis, unikalus
	}
\end{center}

{\hspace{2.5cm} {\bf Užsakovas:} \hfill \parbox{12.0cm}{testas2, tastinė vieta, Įmonės kodas, 745866666}} % Reikia čia įrašyti užsakovo rekvizitus  iš programos atitinkamo įvedimo lango

\vspace{0.5cm}

{\hspace{2.5cm} {\bf Vykdytojas:} \hfill \parbox{12.0cm}{Statybinių medžiagų ir konstrukcijų tyrimu centras, Vilniaus pagrindinis filialas, Lvovo gatvė, 5, Įmonės kodas, 253258686}} % Šitą lauką galima užharkodinti 
...
\hspace{5.25cm} {\bf Bandymai atlikti:} {2024 m. gegužės 13 d.} % Reikia čia įrašyti bandymų atlikimo datą iš programos įvedimo lango

\hspace{5.25cm} \nin {\bf Bandiniai gauti:} {2024 m. gegužės 13 d.} % Reikia čia įrašyti bandinių gavimo datą iš programos įvedimo lango

\vspace{0.5cm}
\hspace{5.25cm} {\bf Bandinius pristatė:} {Vykdytojas}. % Reikia čia įrašyti kas bandinius pristatė, galima padaryti ir pasirinkimus: Užsakovas / Užsakovo įgaliotas atstovas / Vykdytojas  Į

\hspace{5.25cm} {\bf Bandymus atliko:} {Domas Milinavičius}. % Reikia čia įrašyti laboranto vardą ir pavardę

\hspace{5.25cm} {\bf Protokolą sudarė:} {Domas Milinavičius}.% Reikia čia įrašyti protokolo sudarytojo vardą ir pavardę

\section{Bandinių imties apibūdinimas}

\hspace{\parindent}{\bf Bandymo tipas pagal LST EN 206-1 8.2.1.2 ir/arba 8.2.1.3 pastraipas:} {Pradinis }
...
{\bf Gautos arba paimtos imties dydis:} $ 14 $ betoniniai kubeliai. 
...
\begin{enumerate}
	\item \hspace{\parindent}Vidutinio gniuždomojo striprio įvertis $ f_{cm,cube} =  68.4458 $ MPa % Čia reikia įrašyti apskaičiuotą betono vidutinio stiprio įvertį
	...
	\item  Charakteristinio stiprio įvertis $ f_{ck,cube} = 64.446 $ MPa % Čia reikia įrašyti apskaičiuotą betono kubelinio stiprumo standartinio nuokrypio įvertį
	      
	\item Artimaiausia mažesnė betono klasė nustatyta pagal kubelinį stiprį $f_{ck,cube}$: $ C55/67 $
\end{enumerate}
...
\begin{table}[H] % Čia turėtu būti parametras [t] lentelės patalpinimui puslapio viršuje
	...
	\begin{tabular}
		...
		\hline
		1 & 149.999 \\ 149.999 \\ 149.999 \\ 149.999 \\ 149.999 \\ 149.999 & 149.993 \\ 149.992 \\ 149.992 \\ 149.993 \\ 149.993 \\ 149.991 & 1550 & 68.893 & \small{}  \\
		\hline
		2 & 150.001 \\ 150.001 \\ 150.001 \\ 150.001 \\ 150.001 \\ 150.001 & 149.998 \\ 149.998 \\ 149.998 \\ 149.997 \\ 149.998 \\ 149.996 & 1540  & 68.445 & \small{}  \\
		\hline
		3 & 150.006 \\ 150.006 \\ 150.006 \\ 150.006 \\ 150.006 \\ 150.006 & 149.995 \\ 149.995 \\ 149.995 \\ 149.995 \\ 149.995 \\ 149.995 & 1530  & 68 & \small{kubelis nukrito ant žemės} \\
		\hline
		\end{tabular}%
