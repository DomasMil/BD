...
\chead{}
\rhead{\bf Prot. Nr.~97 ; \today} % Bandymų protokolo numerį reikia įrašyti. 
...
\begin{center}
	{\Large Betono kubelinio stiprio nustatymas pagal {\bf LST EN 12390-3}\\
		Bandymų protokolas {\bf \Large \textcolor{blue}{Nr.~97}}\\ % Bandymų protokolo numerį reikia įrašyti. Jis gali būti generuojamas  automatiškai programos, tačiau tas protokolo numeris negali kartotis, kiekvieno protokolo numeris turi būti vienintelis, unikalus
	}
\end{center}

{\hspace{2.5cm} {\bf Užsakovas:} \hfill \parbox{12.0cm}{nauja imon, nauja g 2, Šiauliai, Įmonės kodas, 857899966}} % Reikia čia įrašyti užsakovo rekvizitus  iš programos atitinkamo įvedimo lango

\vspace{0.5cm}

{\hspace{2.5cm} {\bf Vykdytojas:} \hfill \parbox{12.0cm}{Statybinių medžiagų ir konstrukcijų tyrimu centras, Vilniaus pagrindinis filialas, Lvovo gatvė, 6, Įmonės kodas, 253258686}} % Šitą lauką galima užharkodinti 
...
\hspace{5.25cm} {\bf Bandymai atlikti:} {2024 m. gegužės 22 d.} % Reikia čia įrašyti bandymų atlikimo datą iš programos įvedimo lango

\hspace{5.25cm} \nin {\bf Bandiniai gauti:} {2024 m. gegužės 22 d.} % Reikia čia įrašyti bandinių gavimo datą iš programos įvedimo lango

\vspace{0.5cm}
\hspace{5.25cm} {\bf Bandinius pristatė:} {Užsakovas}. % Reikia čia įrašyti kas bandinius pristatė, galima padaryti ir pasirinkimus: Užsakovas / Užsakovo įgaliotas atstovas / Vykdytojas  Į
...
\hspace{\parindent}{\bf Bandymo tipas pagal LST EN 206-1 8.2.1.2 ir/arba 8.2.1.3 pastraipas:} {Periodinis }
...
{\bf Betono tipas pagal tankį}: {Lengvasis}.% Čia reikia įrašyti betono tipą pagal tankį. dar gali būti kitas pasirinkimas - lengvasis betonas. T.y. iš viso du pasirinkimai: {sunkusis arba normalusi} ir {lengvasis}.

{\bf Gautos arba paimtos imties dydis:} $ 2 $ betoniniai kubeliai. 
...
Po pirminės apžiūros bandymui atrinkta $ 1 $ kubeliai,
...
$ 0 $ kubeliai (kubeliai) neatiktiniai. % Šis įrašas daromas jei yra išbrokuotų kubelių,
...
\begin{enumerate}
	\item \hspace{\parindent}Vidutinio gniuždomojo striprio įvertis $ f_{cm,cube} =  0 $ MPa % Čia reikia įrašyti apskaičiuotą betono vidutinio stiprio įvertį
	...
	\item  Charakteristinio stiprio įvertis $ f_{ck,cube} = 25.961 $ MPa % Čia reikia įrašyti apskaičiuotą betono kubelinio stiprumo standartinio nuokrypio įvertį
	      
	\item Artimaiausia mažesnė betono klasė nustatyta pagal kubelinį stiprį $f_{ck,cube}$: $ C25/30 $
\end{enumerate}
...
\begin{table}[H] % Čia turėtu būti parametras [t] lentelės patalpinimui puslapio viršuje
	...
	\begin{tabular}
		...
		\hline
		1 & 149 \\ 150 \\ 150 \\ 150 \\ 150 \\ 150 & 149.55 \\ 150 \\ 150 \\ 150 \\ 150 \\ 150 & 550 & 24.484 & \small{}  \\
		\hline
		\end{tabular}%
