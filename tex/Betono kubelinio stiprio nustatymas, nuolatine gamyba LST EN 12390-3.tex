...
\chead{}
\rhead{\bf Prot. Nr.~84 ; \today} % Bandymų protokolo numerį reikia įrašyti. 
...
\begin{center}
	{\Large Betono kubelinio stiprio nustatymas pagal {\bf LST EN 12390-3}\\
		Bandymų protokolas {\bf \Large \textcolor{blue}{Nr.~84}}\\ % Bandymų protokolo numerį reikia įrašyti. Jis gali būti generuojamas  automatiškai programos, tačiau tas protokolo numeris negali kartotis, kiekvieno protokolo numeris turi būti vienintelis, unikalus
	}
\end{center}

{\hspace{2.5cm} {\bf Užsakovas:} \hfill \parbox{12.0cm}{Baltics Construction Solutions, Nauja g. 55, Įmonės kodas, 632596335}} % Reikia čia įrašyti užsakovo rekvizitus  iš programos atitinkamo įvedimo lango
...
\hspace{5.25cm} {\bf Bandymai atlikti:} {2024 m. gegužės 07 d.} % Reikia čia įrašyti bandymų atlikimo datą iš programos įvedimo lango

\hspace{5.25cm} \nin {\bf Bandiniai gauti:} {2024 m. gegužės 07 d.} % Reikia čia įrašyti bandinių gavimo datą iš programos įvedimo lango
...
\hspace{\parindent}{\bf Bandymo tipas pagal LST EN 206-1 8.2.1.2 ir/arba 8.2.1.3 pastraipas:} {Nuolatinis }
...
{\bf Gautos arba paimtos imties dydis:} $ 5 $ betoniniai kubeliai. 
...
\begin{enumerate}
	...
	\item  Charakteristinio stiprio įvertis $ f_{ck,cube} = 25.921 $ MPa % Čia reikia įrašyti apskaičiuotą betono kubelinio stiprumo standartinio nuokrypio įvertį
...
\begin{table}[H] % Čia turėtu būti parametras [t] lentelės patalpinimui puslapio viršuje
	...
	\begin{tabular}
		...
		\hline
		1 & 150.003 \\ 150 \\ 150 \\ 150.004 \\ 150 \\ 150 & 150 \\ 149.997 \\ 150 \\ 150.003 \\ 150 \\ 150.005 & 550 & 24.444 & \small{}  \\
		\hline
		\end{tabular}%
