...
\chead{}
\rhead{\bf Prot. Nr.~104 ; \today} % Bandymų protokolo numerį reikia įrašyti. 
...
\begin{center}
	{\Large Betono kubelinio stiprio nustatymas pagal {\bf LST EN 12390-3}\\
		Bandymų protokolas {\bf \Large \textcolor{blue}{Nr.~104, \today}}\\ % Bandymų protokolo numerį reikia įrašyti. Jis gali būti generuojamas  automatiškai programos, tačiau tas protokolo numeris negali kartotis, kiekvieno protokolo numeris turi būti vienintelis, unikalus
	}
\end{center}
...
\hspace{5.25cm} \nin {\bf Bandiniai gauti:} {2024 m. birželio 01 d.} % Reikia čia įrašyti bandinių gavimo datą iš programos įvedimo lango
...
\begin{enumerate}
	\item \hspace{\parindent}Vidutinio gniuždomojo striprio įvertis $ f_{cm,cube} =  25.922 $ MPa % Čia reikia įrašyti apskaičiuotą betono vidutinio stiprio įvertį
	...
	\item  Charakteristinio stiprio įvertis $ f_{ck,cube} = 24.4444 $ MPa % Čia reikia įrašyti apskaičiuotą betono kubelinio stiprumo standartinio nuokrypio įvertį
